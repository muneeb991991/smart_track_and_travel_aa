...
class CheckType2 extends StatefulWidget {
  const CheckType2({Key? key}) : super(key: key);
  @override
  State<CheckType2> createState() => _CheckTypeState();
}

class _CheckTypeState extends State<CheckType2> {
  @override
  void initState() {
    inputDat();
