...
class BlockedDriver extends StatefulWidget {
  const BlockedDriver({Key? key}) : super(key: key);

  @override
  State<BlockedDriver> createState() => _AdminHomeState();
}

class _AdminHomeState extends State<BlockedDriver> {
  ...
  void initState() {
    ...
    Query referenceData = FirebaseDatabase.instance.reference().child("Drivers").orderByChild("status").equalTo("Blocked");
